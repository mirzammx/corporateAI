...
import { Drawer,
    ...
    DrawerTitle,DrawerTrigger } from "@/components/ui/drawer" ;       
...
export const DashboardUserButton=()=>{
    ...
    if(isMobile){
        return(
            <Drawer>
                <DrawerTrigger className="rounded-lg border border/10 p-3 w-full flex items-center justify-between bg-white/5 
                hover:bg-white/10 overflow-hidden">{data.user.image?(
            <Avatar>
